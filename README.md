...
- `commands/` — 67 slash commands (installed to `~/.claude/commands/`)
- `agents/` — 65 specialist agents (installed to `~/.claude/agents/`)
- `skills/` — 172 skills (installed to `~/.claude/skills/`)
