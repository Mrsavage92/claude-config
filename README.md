...
- `commands/` — 85 slash commands (installed to `~/.claude/commands/`)
- `agents/` — 66 specialist agents (installed to `~/.claude/agents/`)
- `skills/` — 194 skills (installed to `~/.claude/skills/`)
