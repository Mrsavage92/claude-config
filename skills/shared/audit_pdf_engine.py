...
SHOCK_STATS = {
    ...
    # Social Footprint
    "soc-01": ("social", "risk",
               "Brands that post Reels consistently see 2–3× more reach than static posts — yet most SMBs post static-only content.",
               "Meta for Business, Reels Insights 2024"),
    "soc-02": ("social", "opportunity",
               "73% of Australians aged 18–44 discover new products and services through social media.",
               "Sensis Social Media Report 2024"),
    "soc-03": ("social", "risk",
               "Brands with dormant social accounts for 90+ days see average follower engagement drop by 40%.",
               "Sprout Social Index 2024"),
    "soc-04": ("social", "opportunity",
               "TikTok has overtaken Google as the most-used search tool for 18–24 year olds in AU for product discovery.",
               "GWI Zeitgeist AU Report 2024"),
    # AI Readiness
