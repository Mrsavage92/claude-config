...
**Before competitor research — check for Stitch DESIGN.md:** If `.stitch/DESIGN.md` exists in the project root (output from a `/stitch-design` canvas session), read it in full. Use its color palette, typography, and roundness values to pre-populate your decisions in Steps 1, 3, and 4. The Stitch DESIGN.md informs but does not replace the full research — still complete the competitor analysis, component lock, and differentiation audit. Do not duplicate the aesthetic decisions already locked in Stitch.
